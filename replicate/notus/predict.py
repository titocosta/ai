...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        prompt_template: str = Input(description="Prompt template", default=PROMPT_TEMPLATE_2),
        system_message: str = Input(description="System message", default="You are a helpful AI assistant."),
